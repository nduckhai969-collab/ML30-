...
class MobileNetV2Classifier(nn.Module):
    ...
    def __init__(
        ...
        # MobileNetV2 dùng backbone.classifier thay vì backbone.fc
        # classifier[-1] là Linear(1280, 1000) — thay bằng head của mình
...
if __name__ == "__main__":
    ...
    # Tính đường dẫn từ vị trí file này lên root project
    BASE_DIR = os.path.dirname(  # models/
        os.path.dirname(          # NhanDienThuCung/  ← root
    ...
    train_mobilenet_v2(
        ...
        fine_tune_epoch=5,
        patience=5,
        save_dir=os.path.join(BASE_DIR, "results", "mobilenet_v2")
    )