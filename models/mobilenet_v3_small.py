...
class MobileNetV3SmallClassifier(nn.Module):
    ...
    def __init__(
        ...
        # MobileNetV3 Small: classifier gồm
    ...
    def unfreeze_from(self, layer_index=70):
...
def train_mobilenet_v3_small(
        ...
        fine_tune_epoch=5,
        patience=5,
        save_dir="results/mobilenet_v3_small"
):
...
if __name__ == "__main__":
    ...
    train_mobilenet_v3_small(
        ...
        fine_tune_epoch=5,
        patience=5,
        save_dir=os.path.join(BASE_DIR, "results", "mobilenet_v3_small")
    )
